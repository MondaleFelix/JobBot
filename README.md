...
[![Go Report Card](https://goreportcard.com/badge/github.com/MondaleFelix/makescraper)](https://goreportcard.com/report/github.com/MondaleFelix/makescraper)
...
2. Run each command line-by-line in your terminal to set up the project:
    ...
    $ git remote add origin git@github.com:MondaleFelix/makescraper.git
    $ go mod download
    ```

3. Open `README.md` in your editor and replace all instances of `MondaleFelix` with your GitHub username to enable the Go Report Card badge.
